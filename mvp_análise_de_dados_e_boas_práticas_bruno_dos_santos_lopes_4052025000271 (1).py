Link para o Executável no Google Colab:  https://colab.research.google.com/drive/1KOzFIcVXbD6gHSF3sbVChaiPJ5BySZLE#scrollTo=cmYX3PLx58Jg
...
base_url = "https://raw.githubusercontent.com/BrunoLopes011/EntregaMVP2/main/"
...
order_products_train = pd.read_csv(base_url + "order_products__train.csv")
order_products_prior = pd.read_csv(base_url + "order_products__prior.csv")
...
print("\nProdutos comprados anteriormente (order_products_prior.csv):")
